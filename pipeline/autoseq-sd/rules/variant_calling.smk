...
# Germline variant callers - HaplotypeCaller, StrelkaGermline
...
rule strelka_germline:
    input:
        bam = capture_to_results[NORMAL_CAPTURE].umibam,
        reference = reference['reference_genome'],
        call_region = reference['small_design'][capture_s2]['targets-bed-gz'],
    output:
...
rule strelka_somatic:
    input:
        ...
        target_bed = reference['small_design'][capture_s2]['targets-bed-gz']
    output:
