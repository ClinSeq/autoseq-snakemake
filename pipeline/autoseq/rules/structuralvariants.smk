...
####################################################################
# This svcaller mock rule is to create dummy svcaller output files 
# to support frankenplot process. 
# Remove this rule when frankenplot updates to support gridss output.
####################################################################
