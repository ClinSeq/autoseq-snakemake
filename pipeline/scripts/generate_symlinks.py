...
class GenerateSymlink():
    ...
    def create_igv_session_file(self):
        ...
        try:
            ...
            if not os.path.exists(igv_session_master): raise Exception('IGV session master file not found : igv_session_master.xml ' )
            if not os.path.exists(igv_session_master): raise Exception('IGV session master file not found : igv_session_sv_master.xml ' )
