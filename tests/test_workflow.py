...
class TestWorkflow(unittest.TestCase):
    ...
    def setUp(self):
        self.snakefile = "pipeline/Snakefile"
    ...
    def test_liqbio_valid(self, mock_isfile, mock_get_chromosomes):
    ...
    @patch("pipeline.utils.utils.os.path.isfile")
    @patch("pipeline.utils.utils.get_chromosomes")
    def test_liqbio_invalid(self, mock_isfile, mock_get_chromosomes):
        mock_isfile.return_value = True
